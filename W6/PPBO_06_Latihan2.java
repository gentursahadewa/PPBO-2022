...
public class PPBO_06_Latihan2 {
    public static void main(String[] args) {
        ...
        mhs.put("M0521001", mahasiswaArr.get(0));
        mhs.put("M0521002", mahasiswaArr.get(1));
        mhs.put("M0521003", mahasiswaArr.get(2));
        mhs.put("M0521004", mahasiswaArr.get(3));
        mhs.put("M0521005", mahasiswaArr.get(4));

        for(Map.Entry<String, Mahasiswa> arrayItem: mhs.entrySet()){
            System.out.println("Key: " + arrayItem.getKey() + " => " + "Data mahasiswa: "
                                       + arrayItem.getValue().nama   + ", " 
                                       + arrayItem.getValue().NIM    + ", " 
                                       + arrayItem.getValue().angkatan);
        }
    }
}
